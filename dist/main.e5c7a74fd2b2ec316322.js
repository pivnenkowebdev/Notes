...
var BaseClassCreator = /** @class */ (function () {
    function BaseClassCreator(params) {
        this.element = this.createNewElement(params);
    }
    return BaseClassCreator;
}());
var Creator = /** @class */ (function (_super) {
    ...
    Creator.prototype.setInnerText = function (value) {
        if (value && value.trim().length > 0) {
            this.element.innerText = value;
        }
    };
    Creator.prototype.setId = function (id) {
...
var BaseClassView = /** @class */ (function () {
    function BaseClassView(params) {
        this.component = new creator(params);
    }
    return BaseClassView;
}());
var View = /** @class */ (function (_super) {
    ...
    View.prototype.getComponent = function () {
        return this.component.getHtmlElement();
    };
    View.prototype.createElement = function (params) {
        var newElement = new creator(params);
        return newElement.getHtmlElement();
    };
    View.prototype.addInnerElement = function (parent, element) {
...
;// ./src/core/header/night-mode-btn/night-mode-btn.ts
var night_mode_btn_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
;// ./src/core/header/header-view.ts
var header_view_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };
...
;// ./src/core/main/controls/nav-view.ts
...
;// ./src/core/main/note-modal/modal-note-view.ts
...
;// ./src/core/utilities/data-handler.ts
...
;// ./src/core/main/list-notes/list-notes-view.ts
...
;// ./src/core/main/list-notes/list-notes-controller.ts
...
;// ./src/core/main/note-modal/modal-note-controller.ts
...
;// ./src/core/main/controls/new-note-btn.ts
    ...
    function NewNoteBtn() {
        ...
        _this.visibleModal = function () {
            ...
            if (!isModal) {
                ...
                new modal_note_controller(isNewNote);
            }
        };
        _this.configureView();
        return _this;
...
;// ./src/core/main/search/search.ts
...
;// ./src/core/main/controls/control-elements-view.ts
...
var App = /** @class */ (function () {
    ...
    App.prototype.insertTemplate = function () {
        appContainer.append(this.header.getComponent(), this.controllElements.getComponent(), this.listNotesController.listNotesView.getComponent());
    };
    return App;
}());
